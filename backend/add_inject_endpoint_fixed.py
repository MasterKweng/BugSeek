"""
添加智能注入鉴权信息接口到 auth_config.py（包含正确的导入）
"""
import sys
import os
...
# 1. 修复导入
old_import = 'from app.db.base import AuthConfig, AuthInputMapping, AuthExtractRule, Project'
new_import = 'from app.db.base import (\n    AuthConfig, AuthInputMapping, AuthExtractRule, Project,\n    Environment, ProjectAuthTemplate, ProjectAuthTemplateMapping, ProjectAuthTemplateRule\n)'
